"""
ETL Sleep Quality — Ingesta SLEEP_BRAIN.md al RAG
...
def ingest_sleep():
    print("Starting Sleep Quality Brain Ingestion...")
    vs = VectorStore()
    chunker = Chunker()

    source = ROOT_DIR / "sleep" / "SLEEP_BRAIN.md"
    ...
    for i, chunk_text in enumerate(chunks):
        ...
        chunk_uuid = chunker.generate_deterministic_id("sleep", source.name, i)
    ...
    print(f"Sleep Brain: {total} chunks ingested")
    return total
