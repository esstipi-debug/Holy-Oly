...
const VictoryScreen: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-full bg-holy-bg relative anim-scale-in" style={{ paddingBottom: 20 }}>
      {/* Background Glows */}
      ...
      <div className="px-6 pt-10 pb-6 flex flex-col items-center text-center relative z-10">
        ...
        <div className="relative mb-6">
          ...
          <div className="absolute -bottom-3 -right-3 bg-holy-primary text-holy-text text-[10px] font-black px-2 py-0.5 rounded-full border-2 border-holy-bg shadow-xl">
            PR!
          </div>
        </div>

        <header className="space-y-1 mb-7">
          <h1 className="text-holy-text text-3xl font-black italic tracking-tighter uppercase leading-none">SESIÓN COMPLETADA</h1>
        ...
        <div className="grid grid-cols-2 gap-3 w-full mb-6">
          <Card variant="solid" className="bg-white/5 border-white/5">
            <p className="text-holy-text-secondary text-[9px] font-black uppercase mb-1">XP GANADA</p>
            <p className="text-holy-text text-2xl font-black">+450 XP</p>
          </Card>
          <Card variant="solid" className="bg-white/5 border-white/5">
            <p className="text-holy-text-secondary text-[9px] font-black uppercase mb-1">TONELAJE TOTAL</p>
            <p className="text-holy-text text-2xl font-black">4,250 kg</p>
          </Card>
        </div>
        ...
        <Card variant="glass" className="w-full space-y-4">
           <div className="space-y-2">
             <div className="flex justify-between items-end">
               <span className="text-holy-text text-[10px] font-bold">NIVEL 14</span>
               <span className="text-holy-text-secondary text-[10px] font-bold">450 / 1000 XP</span>
             </div>
           ...
           <div className="flex justify-between items-center pt-2 border-t border-white/5">
              <div className="flex items-center gap-2">
                 ...
                 <div>
                    <p className="text-holy-text text-xs font-bold text-left">Racha de 12 días</p>
                    <p className="text-holy-text-secondary text-[9px] text-left uppercase">Multiplicador 1.2x ACTIVO</p>
                 </div>
              </div>
      ...
      <footer className="p-6 pt-0 space-y-3 relative z-10">
         ...
         <Button fullWidth variant="ghost" className="text-holy-text-secondary" onClick={() => navigate('HOME')}>Volver al Dashboard</Button>
      </footer>
    </div>
  );
};
